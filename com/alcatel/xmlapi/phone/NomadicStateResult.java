...
public class NomadicStateResult  implements java.io.Serializable {
    private com.alcatel.xmlapi.phone.AlcStatus status;
    private com.alcatel.xmlapi.phone.NomadMode state;
    private java.lang.String homeNumber;

    public NomadicStateResult() {
    }
    ...
    public com.alcatel.xmlapi.phone.NomadMode getState() {
        return state;
    }

    public void setState(com.alcatel.xmlapi.phone.NomadMode state) {
        this.state = state;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof NomadicStateResult)) return false;
        NomadicStateResult other = (NomadicStateResult) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(NomadicStateResult.class);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://xmlapi.alcatel.com/phone", "NomadicStateResult"));
